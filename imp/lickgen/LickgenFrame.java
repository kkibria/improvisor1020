...
private void gradeGoodBtnActionPerformed(java.awt.event.ActionEvent evt)
 {
    ...
    private void initComponents()
    {
        ...
        generationGapLabel.setText("Lead (beats):");
        ...
        generationGapLabel.setPreferredSize(new java.awt.Dimension(100, 14));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 2;
        ...
        gapField.setToolTipText("Specifies the lead time, in beats, for generating next chorus before the end of the current chorus.");
